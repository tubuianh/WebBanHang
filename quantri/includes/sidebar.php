        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/webbanhang/quantri">
            ...
            <li class="nav-item">
                ...
                <div id="collapseThere" class="collapse" aria-labelledby="headingUtilities"
