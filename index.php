    ...
    <section class="featured spad">
        <div class="container">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <?php 
                                ...
                                while ($row = mysqli_fetch_assoc($result)){            
                            ?>
                                <li data-filter=".<?php echo $row['slug']; ?>"><?php echo $row['name'] ;?></li>
                            <?php } ?>
            ...
            <div class="row featured__filter">
                ...
                ?>
                <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo $row['cslug']; ?>">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo "quantri/".$anh_arr[0]; ?>">
